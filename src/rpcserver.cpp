...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "MNPCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MNPCoin features */
        {"mnpcoin", "masternode", &masternode, true, true, false},
        {"mnpcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"mnpcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mnpcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mnpcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mnpcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"mnpcoin", "startmasternode", &startmasternode, true, true, false},
        {"mnpcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mnpcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mnpcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mnpcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mnpcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mnpcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mnpcoin", "mnbudget", &mnbudget, true, true, false},
        {"mnpcoin", "preparebudget", &preparebudget, true, true, false},
        {"mnpcoin", "submitbudget", &submitbudget, true, true, false},
        {"mnpcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mnpcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mnpcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mnpcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mnpcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mnpcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mnpcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mnpcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"mnpcoin", "mnsync", &mnsync, true, true, false},
        {"mnpcoin", "spork", &spork, true, true, false},
        {"mnpcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mnpcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> mnpcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13373/\n";
}
