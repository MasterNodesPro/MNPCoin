...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MNPCoin Core mnpcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mnpcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mnpcoin transaction") + "\n" +
                               "  mnpcoin-tx [options] -create [commands]   " + _("Create hex-encoded mnpcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mnpcoin transaction
