...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in mnpcoin\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zMNPsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zMNP denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zMNP denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zMNP denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zMNP denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zMNP denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zMNP denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zMNP denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zMNP denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zMNP denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of mnpcoin addresses\n"
            "     \"mnpcoinaddress\"   	 	(string) mnpcoin address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
