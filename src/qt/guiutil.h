...
/** Utility functions used by the MNPCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render MNPCOIN addresses in monospace font
...
// Parse "mnpcoin:" URI into recipient object, return true on successful parsing
