                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MNPCOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MNPCOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mnpcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMNP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MNPCOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about MNPCOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MNPCOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MNPCOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MNPCOIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a MNPCOIN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MNPCOIN Core help message to get a list with possible MNPCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MNPCOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MNPCOIN network", "", count));
}
...
{
    QString strTitle = tr("MNPCOIN Core"); // default title
