/* src/config/mnpcoin-config.h.  Generated from mnpcoin-config.h.in by configure.  */
/* src/config/mnpcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.mnpcoin.pro"
