...
This mechanism has been integrated into Bitcore-Node-MNPCOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/MNPCOIN-Project/insight-api-mnpcoin#web-socket-api](https://github.com/MNPCOIN-Project/insight-api-mnpcoin#web-socket-api)
* API: [https://github.com/MNPCOIN-Project/insight-api-mnpcoin#swifttx-transactions](https://github.com/MNPCOIN-Project/insight-api-mnpcoin#swifttx-transactions)
...
By default, the MNPCOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MNPCOIN Core daemon:
