...
In order to support loading of multiple wallets in mnpcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mnpcoin.cpp.
...
Changes to mnpcoin.cpp
----------------------
mnpcoin.cpp is the entry point into mnpcoin-qt, and as such, will require some minor modifications to provide hooks for
