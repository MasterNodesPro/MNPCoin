...
RESOURCES += src/qt/mnpcoin.qrc src/qt/mnpcoin_locale.qrc

TRANSLATIONS += src/qt/locale/mnpcoin_bg.ts \
                src/qt/locale/mnpcoin_de.ts \
                src/qt/locale/mnpcoin_en.ts \
                src/qt/locale/mnpcoin_es.ts \
                src/qt/locale/mnpcoin_fi.ts \
                src/qt/locale/mnpcoin_fr.ts \
                src/qt/locale/mnpcoin_it.ts \
                src/qt/locale/mnpcoin_ja.ts \
                src/qt/locale/mnpcoin_pl.ts \
                src/qt/locale/mnpcoin_pt.ts \
                src/qt/locale/mnpcoin_ru.ts \
                src/qt/locale/mnpcoin_sk.ts \
                src/qt/locale/mnpcoin_sv.ts \
                src/qt/locale/mnpcoin_vi.ts \
                src/qt/locale/mnpcoin_zh_CN.ts \
                src/qt/locale/mnpcoin_zh_TW.ts
